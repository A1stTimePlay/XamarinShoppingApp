...
namespace XamarinShoppingApp.ViewModels.Bookmarks
{
    /// <summary>
    ...
    public class CartPageViewModel : BaseViewModel
    {
        ...
        private ObservableCollection<CartItem> cartDetails;
        ...
        private ObservableCollection<CartItem> produts;
        ...
        /// </summary>
        public ObservableCollection<CartItem> CartDetails
        {
            get
            {
        ...
        */
        ...
        private void GetProducts(ObservableCollection<CartItem> Products)
        {
            this.CartDetails = new ObservableCollection<CartItem>();
